...
export function Hero({
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-primary via-primary to-navy-700 text-primary-foreground">
      <div
        aria-hidden
      ...
      <div className="container relative py-20 md:py-28">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-balance text-base text-primary-foreground/80 md:text-lg">
            {subtitle}
          </p>
