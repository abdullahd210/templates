...
const alertVariants = cva("relative w-full rounded-lg border p-4 text-sm [&>svg]:absolute [&>svg]:text-current [&>svg+div]:translate-y-[-2px] [&>svg~*]:ps-7 [&>svg]:start-4 [&>svg]:top-4", {
  variants: {
    variant: {
      ...
      warning: "border-orange-300 bg-orange-50 text-orange-900 [&>svg]:text-accent",
    },
  },
